...
The project is split into two published modules and one build-only module:
...
| Path                                                              | Purpose                                                                |
|-------------------------------------------------------------------|------------------------------------------------------------------------|
| `settings.gradle.kts`                                             | Declares both submodules and wires `build-logic` as an included build. |
...
| `./gradlew publishToMavenLocal`       | Publish both modules to your local Maven repository for testing in a game project. |
